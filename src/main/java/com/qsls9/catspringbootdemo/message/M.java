...
import com.qsls9.catspringbootdemo.util.HttpUtils;
...
public class M {
     ...
     * @return string json_string
     */
    public String send_group_at_msg(String robot_wxid, String to_wxid, String at_wxid, String at_name, String msg) throws IOException {
        // 封装返回数据结构
        HashMap<String, String> map = new HashMap<String, String>();
     ...
     * @return string json_string
     */
    public String send_image_msg(String robot_wxid, String to_wxid, String path) throws IOException {
        // 封装返回数据结构
        HashMap<String, String> map = new HashMap<String, String>();
     ...
     * @return string 当前框架已登录的账号信息列表
     */
    public String get_friend_list(String robot_wxid, String is_refresh) throws IOException {
        // 封装返回数据结构
        HashMap<String, String> map = new HashMap<String, String>();
     ...
     * @return string json_string
     */
    public String agree_friend_verify(String robot_wxid, String json_string) throws IOException {
        // 封装返回数据结构
        HashMap<String, String> map = new HashMap<String, String>();
